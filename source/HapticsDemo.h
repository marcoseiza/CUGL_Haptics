...
//
//  Author: Marcos Eizayaga
//  Version: 6/15/21
//
#ifndef HAPTICS_DEMO_H_
#define HAPTICS_DEMO_H_
#include <cugl/cugl.h>

/**
 * Class for a simple Haptics demo application.
 */
class HapticsDemo : public cugl::Application {
protected:
    ...
    /** Haptics intensity user parameter. */
    float _intensity;
    /** Haptics sharpness user parameter. */
    float _sharpness;
    /** Haptics duration user parameter. */
    float _duration;
...
public:
     ...
     */
    HapticsDemo() : Application(), _intensity(1.0), _sharpness(1.0), _duration(1.0)  {}
