...
protected:
    ...
    std::shared_ptr<cugl::scene2::Label> _intensity_label;
    std::shared_ptr<cugl::scene2::Label> _sharpness_label;
    std::shared_ptr<cugl::scene2::Label> _duration_label;
...
public:
     ...
     */
    HelloApp() : Application(), _countdown(-1), _intensity(1.0), _sharpness(1.0), _duration(1.0)  {}
