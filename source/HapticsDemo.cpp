 ...
 */
void HapticsDemo::update(float timestep) {}
...
void HapticsDemo::buildScene() {
    ...
    transient->addListener([=](const std::string& name, bool down){
        if (down) return;
        // Play haptics with given user parameters.
